...
namespace RealEstateWebApplication.Controllers
{
    public class TypesController : Controller
    {
        ...
        public TypesController(RealEstateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Types != null ? 
                          ...
                          Problem("Entity set 'RealEstateDbContext.Types'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Realties", new { id = @type.Id, name = @type.Name });
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RealEstateDbContext.Types'  is null.");
            }
            var @type = await _context.Types.FindAsync(id);
            if (@type != null)
            {
