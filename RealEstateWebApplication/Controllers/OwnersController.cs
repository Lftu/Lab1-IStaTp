...
namespace RealEstateWebApplication.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public OwnersController(RealEstateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Owners != null ? 
                          ...
                          Problem("Entity set 'RealEstateDbContext.Owners'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RealEstateDbContext.Owners'  is null.");
            }
            var owner = await _context.Owners.FindAsync(id);
            if (owner != null)
            {
